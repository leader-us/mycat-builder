...
public class LeaderDBController {
    ...
    public String GeneralPageQuery(@PathVariable("queryname") String queryName,
        ...
        // .addDomainFieldsExclude(MkUser.class,
        // null).addDomainFieldsExclude(MkContract.class, null)
        // .addDomainFieldsExclude(MkBill.class, new String[] { "id" })
        // .withDefaultCondHandler("${and phone like :phone} ${and sex like :sex}
        // ").wtihQueryParams(params)
        // .withOrderBy("order by phone asc
        // ").withPageIndex(pageIndex).withPageSize(pageSize);
